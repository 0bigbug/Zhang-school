let users = [{ name: 'user', pwd: '20300104' }];
let gly = [{ name: '张嘉鹏', pwd: '20300104' }, { name: 'zhangjiapeng', pwd: '20300104' }];
...
btn.onclick = function() {
    ...
    } else if (username.value == localStorage.getItem('username1') && pwd.value == localStorage.getItem('pwd1')) {
        alert("用户登入成功");
